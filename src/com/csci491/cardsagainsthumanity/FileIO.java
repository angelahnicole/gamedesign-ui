...
public class FileIO extends Activity {
	...
	public ArrayList<WhiteCard> hardCodedWhiteCards() {
		...
		for (int i = 0; i < cards.length; i++) {
			whiteCards.add(new WhiteCard(cards[i], null));
		}
		return whiteCards;
	}
