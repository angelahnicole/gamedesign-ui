...
public class CzarActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button buttonCard = (Button) findViewById(R.id.buttonCard);
		buttonCard.setTextColor(getApplication().getResources().getColor(
				R.color.white));
		buttonCard.setBackgroundColor(getApplication().getResources().getColor(
				R.color.black));
	...
	private OnClickListener leftListener = new OnClickListener() {
		public void onClick(View v) {
			...
			card.setText(Globals.getPlays().get(Globals.getIndexWhiteCard())
					.getContent());
	...
	private OnClickListener submitListener = new OnClickListener() {
		public void onClick(View arg0) {
			if (Globals.isGameWinner()) {
				...
				Player player = Globals.getPlays()
						.get(Globals.getIndexWhiteCard()).getOwner();
				int newScore = player.getScore() + 1;
				Globals.getPlays().get(Globals.getIndexWhiteCard()).getOwner()
						.setScore(newScore);
